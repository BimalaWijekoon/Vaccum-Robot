...
export const MqttProvider = ({ children }) => {
  ...
  const connect = () => {
    ...
    mqttClient.on('connect', () => {
      ...
      mqttClient.subscribe(`${prefix}/status/odometry`);
      mqttClient.subscribe(`${prefix}/status/teach`);
    ...
    mqttClient.on('message', (topic, payload) => {
      ...
      try {
        ...
        } else if (topic === `${prefix}/status/odometry`) {
          setOdometry(JSON.parse(msg));
        } else if (topic === `${prefix}/status/teach`) {
          setTeach(JSON.parse(msg));
        }
      } catch (e) {
